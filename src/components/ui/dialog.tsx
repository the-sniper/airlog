  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content 
      ...
      className={cn(
        ...
        "gap-4 border border-border/50 bg-card p-6 shadow-xl sm:rounded-2xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 opacity-70 hover:opacity-100 hover:bg-secondary transition-all">

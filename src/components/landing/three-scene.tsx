    ...
    <div className="relative w-full max-w-lg mx-auto">
      ...
      <div className="relative bg-[#0a0a12] rounded-2xl overflow-hidden border border-white/5">
        ...
        <div className="p-5">
            ...
            >
              <Clock
                className={`w-3.5 h-3.5 ${
                  phase === "recording" ? "text-red-400" : "text-white/30"
                }`}
              />
              <span
          ...
          <div className="relative mb-4 p-4 rounded-xl bg-gradient-to-br from-white/[0.05] to-white/[0.02] border border-white/10 backdrop-blur-sm">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-white/90 leading-relaxed min-h-[44px]">
                  {transcribedText || (
      ...
      {/* Enhanced mini-dashboard - NO GRADIENT */}
      <div className="relative mt-4">
        <div className="relative bg-[#0d0d14] border border-white/10 rounded-xl overflow-hidden">
          {/* Dashboard header */}
          ...
          <div className="p-3 space-y-1.5 max-h-[140px] overflow-hidden">
            {collectedItems.length === 0 ? (
              <div className="text-xs text-white/25 italic py-4 text-center">
              ...
              collectedItems.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center gap-2 py-2 px-3 rounded-lg bg-white/[0.02] hover:bg-white/[0.04] transition-colors animate-fadeIn group"
                ...
                >
                  ...
                  />
                  <span className="text-xs text-white/60 truncate flex-1 group-hover:text-white/80 transition-colors">
          ...
          >
            ...
            <div
              className={`w-10 h-10 rounded-lg flex items-center justify-center mb-3 transition-colors ${
                isActive ? step.activeBg : "bg-white/5"
              }`}
            >
              <Icon
                className={`w-4 h-4 ${
                  isActive ? step.activeColor : "text-white/40"
                }`}
              />
            </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {stats.map((stat, idx) => (
        <div
          key={idx}
          className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:border-indigo-500/20 transition-colors"
        >

...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Get all users including admins with their role information (left join to include both admins and regular users)
    let query = supabase
      .from("users")
      .select("id, first_name, last_name, email, created_at, join_method, company_admin:company_admins(role)")

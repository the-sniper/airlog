...
export interface Tester { id: string; session_id: string; user_id?: string | null; first_name: string; last_name: string; email: string | null; invite_token: string; invite_sent_at: string | null; report_sent_at: string | null; reported_issues: string[]; joined_at: string | null; left_at: string | null; created_at: string; }
